...
class SerialMotorsBus(MotorsBusBase):
    ...
    def record_ranges_of_motion(
        ...
        start_positions = self.sync_read("Present_Position", motor_names, normalize=False, num_retry=2)
        mins = start_positions.copy()
        maxes = start_positions.copy()

        user_pressed_enter = False
        while not user_pressed_enter:
            positions = self.sync_read("Present_Position", motor_names, normalize=False, num_retry=2)
